...
<div className="page-content align-top pl-0 col-md-7 col-lg-9">
  ...
  <div className="new-message">
      <div className="col-12 pl-0 pr-0 pb-2">
        <div contentEditable className="message-box">Type your message...</div>
      </div>
      <div className="col-12 pl-0 pr-0">
        ...
        <div className="col-6 container m-0 float-right pr-0"><button className="btn btn-primary float-right">Send</button></div>
      </div>
    </div>
</div>;
